                ...
                <div class="featured">
                    ...
                    <div class="featured__column featured__column--big">
                        ...
                        <div class="entry" style="background-image:url('/images/thumbs/featured/featured-guitarman.jpg');">
                            ...
                            <div class="entry__content">
                                <span class="entry__category"><a href="/category/<?= $featuredArticleBig->getCatId() ?>"><?= $featuredArticleBig->getCategory()->getName() ?></a></span>

                                <h1><a href="/articles/<?= $featuredArticleBig->getId() ?>" title=""><?= $featuredArticleBig->getName() ?></a></h1>
                    ...
                    <div class="featured__column featured__column--small">
                        ...
                        <div class="entry" style="background-image:url('images/thumbs/featured/featured-guitarman.jpg');">
                            ...
                            <div class="entry__content">
                                <span class="entry__category"><a href="/category/<?= $article->getCatId() ?>"><?= $featuredArticleBig->getCategory()->getName() ?></a></span>

                                <h1><a href="/articles/<?= $article->getId() ?>" title=""><?= $article->getName() ?></a></h1>
                ...
                <nav class="pgn">
                    ...
                    <?php foreach ($pagination->buttons as $button) : ?>
                        <?php if ($button->isActive) : ?>
                            <li><span class="pgn__num"><a href="?page=<?= $button->page ?>"><?=$button->text?></a></span></li>
                        <?php else : ?>
                            <li><?= $button->text ?></li>
                        <?php endif; ?>
                    <?php endforeach; ?>
